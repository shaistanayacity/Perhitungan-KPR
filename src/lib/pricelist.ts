...
export const SIERRA_UNITS: PropertyUnit[] = [
  ...
  { id: "sierra-arnica-pool-e1", cluster: "SIERRA", tipe: "ARNICA Pool", lb: 91, lt: 90, blok: "E1", noUnit: "01-05", hargaAsli: 1_160_000_000, hargaKpr: 1_082_000_000 },
  { id: "sierra-arnica-pool-e8", cluster: "SIERRA", tipe: "ARNICA Pool", lb: 91, lt: 90, blok: "E8", noUnit: "03-09", hargaAsli: 1_180_000_000, hargaKpr: 1_092_425_000 },
  ...
  // ARNICA Garden Hook & ARNICA Pool Hook sama-sama ada di blok E8 (noUnit 10)
  // dan E1 (noUnit 06) — sama seperti ARNICA reguler, ARNICA Pool Hook = ARNICA
  // Garden Hook + penambahan private pool Rp170.000.000.
  ...
  { id: "sierra-arnica-garden-hook-e1-06", cluster: "SIERRA", tipe: "ARNICA Garden Hook", lb: 70, lt: 160, blok: "E1", noUnit: "06", hargaAsli: 1_350_000_000, hargaKpr: 1_237_000_000, specialUnit: true },
  { id: "sierra-arnica-pool-hook-e8-10", cluster: "SIERRA", tipe: "ARNICA Pool Hook", lb: 91, lt: 105.3, blok: "E8", noUnit: "10", hargaAsli: 1_325_000_000, hargaKpr: 1_231_000_000, specialUnit: true },
  { id: "sierra-arnica-pool-hook-e1-06", cluster: "SIERRA", tipe: "ARNICA Pool Hook", lb: 91, lt: 160, blok: "E1", noUnit: "06", hargaAsli: 1_520_000_000, hargaKpr: 1_407_000_000, specialUnit: true },
];
